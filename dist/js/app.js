...
module.exports = san.defineComponent({
  ...
  initData: function initData() {
    ...
    return {
      ...
      // format: 'yyyy-MM-dd',
      disabled: false,
      notBefore: new Date() // notAfter: nextDate,
  ...
  selectTime: function selectTime(time, close) {
    var value = transformDate.formatdate.date2value(time, this.data.get('innnerDateFormat'));
...
module.exports = san.defineComponent({
  ...
  attached: function attached() {
    ...
    this.watch('now', function (val) {
      ...
      _this.data.set('year', year);

      _this.data.set('month', month);
    });
